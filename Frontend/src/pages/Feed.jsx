...
const Feed = () => {
  ...
  const fallbackArtworks = [
    { title: "Peace and Harmony", price: "Rs. 30,000", image: peace, _id: "fallback1", medium: "Acrylic", paper: "Canvas", orientation: "Landscape", frame: "Included" },
    { title: "Living Goddess", price: "Rs. 50,000", image: living, _id: "fallback2", medium: "Oil", paper: "Canvas", orientation: "Portrait", frame: "Included" },
    { title: "Holy Seto Machhindranath", price: "Rs. 40,000", image: seto, _id: "fallback3", medium: "Acrylic", paper: "Waterpad", orientation: "Portrait", frame: "Not Included" },
    { title: "Millions of Dots", price: "Rs. 2,000", image: millions, _id: "fallback4", medium: "Ink", paper: "A4", orientation: "Landscape", frame: "Not Included" },
    { title: "Ganesh of Navadurga Nach", price: "Rs. 10,000", image: ganesh, _id: "fallback5", medium: "Watercolor", paper: "Waterpad", orientation: "Portrait", frame: "Not Included" },
    { title: "Culture behind the Mask", price: "Rs. 60,000", image: culture, _id: "fallback6", medium: "Acrylic", paper: "Canvas", orientation: "Portrait", frame: "Included" },
    { title: "Shree Pachali Bhairav", price: "Rs. 80,000", image: shree, _id: "fallback7", medium: "Acrylic", paper: "Waterpad", orientation: "Portrait", frame: "Not Included" },
    { title: "Gufa", price: "Rs. 10,000", image: gufa, _id: "fallback8", medium: "Digital", paper: "Canvas", orientation: "Landscape", frame: "Not Included" },
    { title: "Green Tara", price: "Rs. 2,000", image: green, _id: "fallback9", medium: "Gouache", paper: "Sketch", orientation: "Portrait", frame: "Not Included" },
    { title: "Sophisticated Nature", price: "Rs. 1,000", image: sop, _id: "fallback10", medium: "Pencil", paper: "A4", orientation: "Landscape", frame: "Not Included" },
  ];
  ...
  const applyFilters = () => {
    ...
    const filtered = artworks.filter(artwork => {
      for (const [category, selectedValue] of Object.entries(filters)) {
        if (selectedValue && artwork[category]?.toLowerCase() !== selectedValue.toLowerCase()) {
          return false;
        }
      }
      return true;
