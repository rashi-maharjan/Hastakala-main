  ...
  return (
    ...
    >
      ...
      <nav className="p-6 flex justify-end">
        <button className="bg-black text-white hover:bg-black/90 rounded-full px-6 py-2 text-sm font-medium transition-colors">
          Sign In
        </button>
      </nav>
      ...
      <main className="container mx-auto px-4 text-center pt-16 md:pt-24 max-w-[800px]">
        ...
        {/* CTA Button */}
        <button className="bg-[#3072E3] hover:bg-[#3072E3]/60 border-none outline-none text-white rounded-[22px] px-5 py-3 text-lg font-medium transition-colors">
          Get Started
        </button>
      </main>
    </div>
